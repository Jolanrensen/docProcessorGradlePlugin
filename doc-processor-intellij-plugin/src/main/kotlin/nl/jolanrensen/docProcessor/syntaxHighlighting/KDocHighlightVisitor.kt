...
//
//        val baseType = HighlightInfoType.HighlightInfoTypeImpl(
//            /* severity = */ HighlightSeverity.WEAK_WARNING,
//            /* attributesKey = */ DefaultLanguageHighlighterColors.METADATA,
//            /* needsUpdateOnTyping = */ true,
//        )
//        return IjHighlightInfo.newHighlightInfo(baseType)
//            .textAttributes(
//                when (type) {
...
//            .range(
//                /* element = */ kdoc,
//                /* start = */ kdoc.startOffset + range.first,
//                /* end = */ kdoc.startOffset + range.last + 1,
//            )
//            .create()
//    }
//
