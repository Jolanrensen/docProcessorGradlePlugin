...
//            dependencies.add(project.dependencies.create("org.jetbrains.kotlin:kotlin-compiler:2.0.0"))
            dependencies.add(project.dependencies.create("org.jetbrains.kotlin:kotlin-compiler:2.0.20-Beta1"))
//            dependencies.add(project.dependencies.create("org.jetbrains.kotlin:idea:$dokkaVersion"))

            dependencies.add(project.dependencies.create("org.jetbrains.dokka:analysis-kotlin-symbols:$dokkaVersion"))
//            dependencies.add(project.dependencies.create("org.jetbrains.dokka:analysis-kotlin-descriptors:$dokkaVersion"))
//            dependencies.add(project.dependencies.create("org.jetbrains.dokka:analysis-kotlin-descriptors-ide:$kotlinVersion"))
//            dependencies.add(project.dependencies.create("org.jetbrains.dokka:analysis-kotlin-descriptors-compiler:$kotlinVersion"))
